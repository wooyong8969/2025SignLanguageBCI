...
if __name__ == "__main__":
    csv_path = r'current_experiments\DATA\raw\experiment_001\SI_30(1-3).csv'
    epoch_table_path = r'current_experiments\DATA\video\experiment_001_60_epochs.xlsx'
    save_dir = r'current_experiments\DATA\processed\experiment_001'
    base_name = 'experiment_001(1-3)'
