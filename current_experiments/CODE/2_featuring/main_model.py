...
# features_path = r'current_experiments\DATA\processed\experiment_001\experiment_001(1-4)_cleaned.npy'
# labels_path = r'current_experiments\DATA\processed\experiment_001\experiment_001(1-4)_labels.npy'

features_path = r'current_experiments\DATA\processed\experiment_002\experiment_002(1-4)_cleaned.npy'
labels_path = r'current_experiments\DATA\processed\experiment_002\experiment_002(1-4)_labels.npy'
...
# ---------- 7. 평가 ---------- #
train_acc = clf_lda.score(X_train_lda, y_train)
test_acc = clf_lda.score(X_test_lda, y_test)

disp = ConfusionMatrixDisplay.from_estimator(clf_lda, X_test_lda, y_test)
