...
if __name__ == "__main__":
    csv_path = r'current_experiments\DATA\raw\experiment_001\SI_30(1-4).csv'
    epoch_table_path = r'current_experiments\DATA\video\experiment_001_90_epochs.xlsx'
    save_dir = r'current_experiments\DATA\processed\experiment_001'
    base_name = 'experiment_001(1-4)'
